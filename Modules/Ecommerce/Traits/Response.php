...
trait Response
{
    ...
    ): mixed
    {
        $response = response()->json(
            data: [
                'status' => false,
                'message' => $message ?? @trans('ecommerce::messages.bad_request'),
                'errors' => $errors,
            ],
    ...
    ): JsonResponse
    {
        return response()->json(
            data: [
                'status' => true,
                'message' => $message ?? @trans('ecommerce::messages.success'),
            ],
    ...
    ): mixed
    {
        $response = response()->json(
            data: [
                'status' => false,
                'message' => $message ?? @trans('ecommerce::messages.unavailable_server'),
            ],
